...
class ReservationsApi
{
    ...
    /**
     * Operation reservationsGetReservation
     *
    ...
    {
        list($response) = $this->reservationsGetReservationWithHttpInfo($reservationid, $authorization);
        return $response;
    }

    /**
     * Operation reservationsGetReservationWithHttpInfo
     *
     * Retrieve a reservation
     *
     * @param  string $reservationid The unique identifier of the reservation (required)
    ...
    {
        $returnType = '\Swagger\Client\Model\ReservationResponse';
        $request = $this->reservationsGetReservationRequest($reservationid, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReservationResponse',
    ...
    /**
     * Operation reservationsGetReservationAsync
     *
     * Retrieve a reservation
     *
     * @param  string $reservationid The unique identifier of the reservation (required)
    ...
    {
        return $this->reservationsGetReservationAsyncWithHttpInfo($reservationid, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reservationsGetReservationAsyncWithHttpInfo
     *
     * Retrieve a reservation
     *
     * @param  string $reservationid The unique identifier of the reservation (required)
    ...
    /**
     * Create request for operation 'reservationsGetReservation'
     *
     * @param  string $reservationid The unique identifier of the reservation (required)
     * @param  string $authorization Access token from AAD. Should start with &#39;Bearer &#39;. (required)
     *
    ...
    protected function reservationsGetReservationRequest($reservationid, $authorization)
    {
        ...
        $resourcePath = '/api/v3-0/reservations/{reservationid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation reservationsPlaceReservationAsync
     *
    ...
    {
        list($response) = $this->reservationsPlaceReservationAsyncWithHttpInfo($request, $authorization);
        return $response;
    }

    /**
     * Operation reservationsPlaceReservationAsyncWithHttpInfo
     *
     * Place a reservation for a product
     *
     * @param  \Swagger\Client\Model\ReservationRequest $request Request for the reservation (required)
    ...
    {
        $returnType = '\Swagger\Client\Model\ReservationResponse';
        $request = $this->reservationsPlaceReservationAsyncRequest($request, $authorization);
    ...
    /**
     * Operation reservationsPlaceReservationAsyncAsync
     *
     * Place a reservation for a product
     *
     * @param  \Swagger\Client\Model\ReservationRequest $request Request for the reservation (required)
    ...
    {
        return $this->reservationsPlaceReservationAsyncAsyncWithHttpInfo($request, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reservationsPlaceReservationAsyncAsyncWithHttpInfo
     *
     * Place a reservation for a product
     *
     * @param  \Swagger\Client\Model\ReservationRequest $request Request for the reservation (required)
    ...
    protected function reservationsPlaceReservationAsyncRequest($request, $authorization)
    {
        ...
        $resourcePath = '/api/v3-0/reservations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
